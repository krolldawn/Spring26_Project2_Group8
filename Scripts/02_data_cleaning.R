...
NHIS <- read.csv("Data/NHIS_Data_2021.csv") #loaded dataset
summary(NHIS) #loaded summary of data to see range of variables

NHIS_clean <- NHIS_Data_2021 %>% #created subset of cleaned dataset
...
summary(NHIS_clean) #loaded summary of cleaned data to verify all variables are within codebook range & missing values removed
